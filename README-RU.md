...
### Важно: процесс замены для iOS 3.x отличается от 4–6. Похоже, что путь к lockdownd там другой? Не /usr/libexec, а /var/stash/libexec – но я точно не знаю, и проверить не на чем. 
